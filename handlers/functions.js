  ...
  try {
    ...
    function reset(track_info_msg, queue_info_msg) {
      let embed2 = new MessageEmbed()
        ...
        .setTitle("EMU Music | Music Queue")
        .setImage("")
        .setDescription(`Empty\nJoin a voice channel and queue songs by name or url in here.`)
      let embed3 = new MessageEmbed()
        .setColor(ee.color)
        .setFooter(ee.footertext, ee.footericon)
        .setTitle("EMU Music | Currently no song is playing!")
        .setDescription(`> Join a voice channel and enter a song name or url to play.\n\n`)
        .setImage("https://media.discordapp.net/attachments/756183640123244695/866567855134736384/Untitled356-20200928104340.PNG?width=290&height=341")
    ...
    function QueueEmbed(client, player) {
      ...
      const embed = new MessageEmbed().setAuthor(`EMU Music | Music Queue`);
      const multiple = 15;
      const page = 1;
